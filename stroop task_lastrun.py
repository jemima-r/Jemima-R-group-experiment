...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\JEMIMA\\Documents\\L in Psych Psychopy\\stroop task_lastrun.py',
...
trials = data.TrialHandler(nReps=10.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/JEMIMA/Downloads/STROOP TASK EXCEL.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp.status == STARTED and not waitOnFlip:
            theseKeys = key_resp.getKeys(keyList=['r','b','o','p'], waitRelease=False)
